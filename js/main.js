		...
		function setSpoilerAction(e) {
		    ...
		    if (el.hasAttribute("data-spoiler") || el.closest("[data-spoiler]")) {
		        ...
		        if (!spoilersBlock.querySelectorAll("._slide").length) {
		            ...
		            // Find the image inside the button and toggle its src
		            const img = spoilerButton.querySelector("img");
		            if (img) {
		                img.src = spoilerButton.classList.contains("_active") ? "assets/arrow-up.png" : "assets/arrow-down.png";
		            }
		        }
		        e.preventDefault();
		    }
